...
The project also includes a GitHub Actions workflow for running the test suite. You can view past runs and results [here](https://github.com/Mamr245/cypress-cucumber-automation-project/actions). 
